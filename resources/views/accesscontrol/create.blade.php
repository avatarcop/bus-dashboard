...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title">Add Access control</h3>
        	...
        	<form class="form-material form-horizontal" id="FormIni" method="POST" enctype="multipart/form-data" action="{{url('accesscontrol/insert')}}">
              {{ csrf_field() }}
                <div class="form-group">
                    <label class="col-md-12" for="example-text">Role code</span></label>
                    <div class="col-md-12">
                        <input type="text" required="" maxlength="45" required="" id="role_code" name="role_code" class="form-control" placeholder="Role code">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-12" for="example-text">Role name</span></label>
                    <div class="col-md-12">
                        <input type="text" required="" maxlength="45" required="" id="role_name" name="role_name" class="form-control" placeholder="Role name">
                    </div>
                </div>
                <div class="form-group">
                ...
                <a href="{{url('accesscontrol')}}" class="btn btn-info waves-effect waves-light m-r-10">Cancel</a>
